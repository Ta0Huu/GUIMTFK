...
LRESULT CALLBACK WndProc(HWND hwnd,UINT message, WPARAM wParam,LPARAM lParam){
		switch(message){
			case WM_CREATE: 
				...
				TextBox1 = CreateWindow("EDIT"," ",WS_BORDER|WS_CHILD|WS_VISIBLE,45,50,150,25,hwnd,NULL,NULL,NULL);
				TextBox2 = CreateWindow("EDIT"," ",WS_BORDER|WS_CHILD|WS_VISIBLE,45,80,150,25,hwnd,NULL,NULL,NULL);
